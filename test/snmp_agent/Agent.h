...
class Agent_registerModule_args {
 public:
  ...
  Agent_registerModule_args(const Agent_registerModule_args&);
  Agent_registerModule_args& operator=(const Agent_registerModule_args&);
...
class Agent_registerModule_result {
 public:
  ...
  Agent_registerModule_result(const Agent_registerModule_result&);
  Agent_registerModule_result& operator=(const Agent_registerModule_result&);
...
class Agent_updateHealthStatus_args {
 public:
  ...
  Agent_updateHealthStatus_args(const Agent_updateHealthStatus_args&);
  Agent_updateHealthStatus_args& operator=(const Agent_updateHealthStatus_args&);
...
class Agent_updateHealthStatus_result {
 public:
  ...
  Agent_updateHealthStatus_result(const Agent_updateHealthStatus_result&);
  Agent_updateHealthStatus_result& operator=(const Agent_updateHealthStatus_result&);
...
class Agent_updateServerStatus_args {
 public:
  ...
  Agent_updateServerStatus_args(const Agent_updateServerStatus_args&);
  Agent_updateServerStatus_args& operator=(const Agent_updateServerStatus_args&);
...
class Agent_updateServerStatus_result {
 public:
  ...
  Agent_updateServerStatus_result(const Agent_updateServerStatus_result&);
  Agent_updateServerStatus_result& operator=(const Agent_updateServerStatus_result&);
...
class Agent_updateNginxStatus_args {
 public:
  ...
  Agent_updateNginxStatus_args(const Agent_updateNginxStatus_args&);
  Agent_updateNginxStatus_args& operator=(const Agent_updateNginxStatus_args&);
...
class Agent_updateNginxStatus_result {
 public:
  ...
  Agent_updateNginxStatus_result(const Agent_updateNginxStatus_result&);
  Agent_updateNginxStatus_result& operator=(const Agent_updateNginxStatus_result&);
...
class Agent_updateSysInfo_args {
 public:
  ...
  Agent_updateSysInfo_args(const Agent_updateSysInfo_args&);
  Agent_updateSysInfo_args& operator=(const Agent_updateSysInfo_args&);
...
class Agent_updateSysInfo_result {
 public:
  ...
  Agent_updateSysInfo_result(const Agent_updateSysInfo_result&);
  Agent_updateSysInfo_result& operator=(const Agent_updateSysInfo_result&);
...
class Agent_updateInterfaceInfo_args {
 public:
  ...
  Agent_updateInterfaceInfo_args(const Agent_updateInterfaceInfo_args&);
  Agent_updateInterfaceInfo_args& operator=(const Agent_updateInterfaceInfo_args&);
...
class Agent_updateInterfaceInfo_result {
 public:
  ...
  Agent_updateInterfaceInfo_result(const Agent_updateInterfaceInfo_result&);
  Agent_updateInterfaceInfo_result& operator=(const Agent_updateInterfaceInfo_result&);
...
class Agent_updateInterfaceTraffic_args {
 public:
  ...
  Agent_updateInterfaceTraffic_args(const Agent_updateInterfaceTraffic_args&);
  Agent_updateInterfaceTraffic_args& operator=(const Agent_updateInterfaceTraffic_args&);
...
class Agent_updateInterfaceTraffic_result {
 public:
  ...
  Agent_updateInterfaceTraffic_result(const Agent_updateInterfaceTraffic_result&);
  Agent_updateInterfaceTraffic_result& operator=(const Agent_updateInterfaceTraffic_result&);
...
class Agent_updateInterfaceIpMac_args {
 public:
  ...
  Agent_updateInterfaceIpMac_args(const Agent_updateInterfaceIpMac_args&);
  Agent_updateInterfaceIpMac_args& operator=(const Agent_updateInterfaceIpMac_args&);
...
class Agent_updateInterfaceIpMac_result {
 public:
  ...
  Agent_updateInterfaceIpMac_result(const Agent_updateInterfaceIpMac_result&);
  Agent_updateInterfaceIpMac_result& operator=(const Agent_updateInterfaceIpMac_result&);
...
class Agent_updateRouteInfo_args {
 public:
  ...
  Agent_updateRouteInfo_args(const Agent_updateRouteInfo_args&);
  Agent_updateRouteInfo_args& operator=(const Agent_updateRouteInfo_args&);
...
class Agent_updateRouteInfo_result {
 public:
  ...
  Agent_updateRouteInfo_result(const Agent_updateRouteInfo_result&);
  Agent_updateRouteInfo_result& operator=(const Agent_updateRouteInfo_result&);
...
class Agent_updateProcessInfo_args {
 public:
  ...
  Agent_updateProcessInfo_args(const Agent_updateProcessInfo_args&);
  Agent_updateProcessInfo_args& operator=(const Agent_updateProcessInfo_args&);
...
class Agent_updateProcessInfo_result {
 public:
  ...
  Agent_updateProcessInfo_result(const Agent_updateProcessInfo_result&);
  Agent_updateProcessInfo_result& operator=(const Agent_updateProcessInfo_result&);
...
class Agent_updateIpSecOnlineIp_args {
 public:
  ...
  Agent_updateIpSecOnlineIp_args(const Agent_updateIpSecOnlineIp_args&);
  Agent_updateIpSecOnlineIp_args& operator=(const Agent_updateIpSecOnlineIp_args&);
...
class Agent_updateIpSecOnlineIp_result {
 public:
  ...
  Agent_updateIpSecOnlineIp_result(const Agent_updateIpSecOnlineIp_result&);
  Agent_updateIpSecOnlineIp_result& operator=(const Agent_updateIpSecOnlineIp_result&);
...
class AgentConcurrentClient : virtual public AgentIf {
 ...
 public:
  ...
  RetCode::type registerModule(const ModuleType::type typ);
  int32_t send_registerModule(const ModuleType::type typ);
  RetCode::type recv_registerModule(const int32_t seqid);
  RetCode::type updateHealthStatus(const std::vector<DialHealthResult> & results);
  int32_t send_updateHealthStatus(const std::vector<DialHealthResult> & results);
  RetCode::type recv_updateHealthStatus(const int32_t seqid);
  RetCode::type updateServerStatus(const std::vector<DialServerResult> & results);
  int32_t send_updateServerStatus(const std::vector<DialServerResult> & results);
  RetCode::type recv_updateServerStatus(const int32_t seqid);
  RetCode::type updateNginxStatus(const std::vector<DialNginxResult> & results);
  int32_t send_updateNginxStatus(const std::vector<DialNginxResult> & results);
  RetCode::type recv_updateNginxStatus(const int32_t seqid);
  RetCode::type updateSysInfo(const std::string& snmp, const SysInfo& sysinfo);
  int32_t send_updateSysInfo(const std::string& snmp, const SysInfo& sysinfo);
  RetCode::type recv_updateSysInfo(const int32_t seqid);
  RetCode::type updateInterfaceInfo(const std::string& snmp, const std::vector<InterfaceInfo> & interfaces);
  int32_t send_updateInterfaceInfo(const std::string& snmp, const std::vector<InterfaceInfo> & interfaces);
  RetCode::type recv_updateInterfaceInfo(const int32_t seqid);
  RetCode::type updateInterfaceTraffic(const std::string& snmp, const std::vector<InterfaceTraffic> & traffic);
  int32_t send_updateInterfaceTraffic(const std::string& snmp, const std::vector<InterfaceTraffic> & traffic);
  RetCode::type recv_updateInterfaceTraffic(const int32_t seqid);
  RetCode::type updateInterfaceIpMac(const std::string& snmp, const std::vector<IpMac> & ipmac);
  int32_t send_updateInterfaceIpMac(const std::string& snmp, const std::vector<IpMac> & ipmac);
  RetCode::type recv_updateInterfaceIpMac(const int32_t seqid);
  RetCode::type updateRouteInfo(const std::string& snmp, const std::vector<RouteInfo> & routeinfo);
  int32_t send_updateRouteInfo(const std::string& snmp, const std::vector<RouteInfo> & routeinfo);
  RetCode::type recv_updateRouteInfo(const int32_t seqid);
  RetCode::type updateProcessInfo(const std::string& snmp, const ProcessInfo& processinfo);
  int32_t send_updateProcessInfo(const std::string& snmp, const ProcessInfo& processinfo);
  RetCode::type recv_updateProcessInfo(const int32_t seqid);
  RetCode::type updateIpSecOnlineIp(const std::string& ipsecid, const std::vector<IpAddr> & iplist);
  int32_t send_updateIpSecOnlineIp(const std::string& ipsecid, const std::vector<IpAddr> & iplist);
  RetCode::type recv_updateIpSecOnlineIp(const int32_t seqid);
 protected:
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> piprot_;
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> poprot_;
  ::apache::thrift::protocol::TProtocol* iprot_;

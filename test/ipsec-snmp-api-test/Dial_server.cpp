...
int main(int argc, char **argv) 
{
		...
		string processname = "edns_dial";
  		...
  		rt = client.addSnmpGroupInfo(snmp);

  		rt = client.addSnmpProcessInfo(snmp.name,processname);
		...
		ipsec.recordId = "test6.0";
  		rt = client.addIpSec(ipsec,10);

		sleep(300);

  		rt = client.delSnmpProcessInfo(snmp.name,processname);
  		rt = client.delSnmpGroupInfo(snmp.name);
  		rt = client.delIpSec(ipsec.recordId);
